const newColourBtnElement = document.getElementById("newColourBtn");
const currentColourElement = document.getElementById("currentColour");
...
newColourBtnElement.addEventListener("click", () => {
    ...
    currentColourElement.textContent = randomHexString; // Update the displayed color
